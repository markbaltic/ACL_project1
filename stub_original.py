...
solver = './cryptominisat5'  # allows calling for Sat Solver
...
class Enc:
    ...
    def x(self,i): return 'x_{}'.format(i)  # variables are encoded for readability & debugging purposes
    ...
    def mk_and(self, l1, l2):  # Create conjunction
    ...
    def mk_cnf(self,print_comments):  # turns strings into numbers for correct input for SAT solver
